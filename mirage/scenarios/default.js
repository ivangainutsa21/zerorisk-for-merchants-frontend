export default function(server) {
  ...
  server.create('saq-answer', { saqId: saqA.id, questionId: q95.id, responseType: 'NOT_APPLICABLE' });
  ...
  server.create('saq-answer', { saqId: saqA.id, questionId: q9sa.id, responseType: 'NOT_APPLICABLE' });
  ...
  server.create('saq-answer', { saqId: saqA.id, questionId: q961.id, responseType: 'NOT_APPLICABLE' });
  ...
  server.create('saq-answer', { saqId: saqA.id, questionId: q962.id, responseType: 'NOT_APPLICABLE' });
  ...
  server.create('saq-answer', { saqId: saqA.id, questionId: q963.id, responseType: 'NOT_APPLICABLE' });
  ...
  server.create('saq-answer', { saqId: saqA.id, questionId: q97.id, responseType: 'NOT_APPLICABLE' });
  ...
  server.create('saq-answer', { saqId: saqA.id, questionId: q98a.id, responseType: 'NOT_APPLICABLE' });
  ...
  server.create('saq-answer', { saqId: saqA.id, questionId: q981a.id, responseType: 'NOT_APPLICABLE' });
  ...
  server.create('saq-answer', { saqId: saqA.id, questionId: q981b.id, responseType: 'NOT_APPLICABLE' });
  ...
  server.create('saq-answer', { saqId: saqA.id, questionId: q1282.id, responseType: 'NOT_APPLICABLE' });
